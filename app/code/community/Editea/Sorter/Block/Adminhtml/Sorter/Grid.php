...
class Editea_Sorter_Block_Adminhtml_Sorter_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $this->addColumn("editea_report_id", array(
        ...
        $this->addColumn("report_level", array(
        "header" => Mage::helper("sorter")->__("Level"),
        "index" => "report_level",
        ));
        $this->addColumn("report_item_id", array(
        "header" => Mage::helper("sorter")->__("Item Id"),
        "index" => "report_item_id",
        ));
        $this->addColumn("report_message", array(
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('remove_sorter', array(
