...
class Editea_Sorter_Adminhtml_SorterController extends Mage_Adminhtml_Controller_Action
{
		...
		{
            $this->loadLayout()->_setActiveMenu("sorter/sorter")->_addBreadcrumb(Mage::helper("adminhtml")->__("Sorter  Manager"),Mage::helper("adminhtml")->__("Sorter Manager"));
            return $this;
		}
		...
		{			    
            ...
            if ($model->getId()) {
                ...
                $this->_addBreadcrumb(Mage::helper("adminhtml")->__("Sorter Manager"), Mage::helper("adminhtml")->__("Sorter Manager"));
                $this->_addBreadcrumb(Mage::helper("adminhtml")->__("Sorter Description"), Mage::helper("adminhtml")->__("Sorter Description"));
		...
		{
			try {
				$ids = $this->getRequest()->getPost('editea_report_ids', array());
				foreach ($ids as $id) {
                      $model = Mage::getModel("sorter/sorter");
